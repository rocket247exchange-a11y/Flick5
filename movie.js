// movie.js - loads selected movie details and plays video
document.addEventListener('DOMContentLoaded', () => {
  ...
  function normalizeVideoUrl(url){
    if(!url) return null;
    try{ const u = new URL(url); if(u.hostname.includes('dropbox.com')){ u.searchParams.set('raw','1'); return u.toString(); } return url; } catch(e){ return url; }
  }
